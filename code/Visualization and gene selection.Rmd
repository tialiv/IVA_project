...
new <- read_excel_allsheets("/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_A6_E3_removed_GSEA_hallmark_20220529.xlsx")
new <- new[[1]]

deg <- read_excel_allsheets("/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_activator_comparison_sig01_20220706.xlsx")
deg <- deg[[1]]

markers <- read.csv2("/Users/tili/Desktop/STAT_ovary/results/tables/cell_type_markers.csv")
...
pdf("/Users/tili/Desktop/STAT_ovary/results/figures/Activator_DEGs_20220609.pdf")
...
d2 <- plotCounts(dds, gene="ENSG00000099194", intgroup=c("Culture", "culture"), normalized = T,
                  returnData=TRUE) 
ggplot(d2, aes(x=culture, y=count, fill = culture)) + 
    geom_boxplot()  + 
    geom_point(size=2, alpha = 0.5) + xlab("") + ylab("normalized count") +
    theme + ggtitle("SCD") +
    scale_fill_manual(values=c("#f0f0f0", "#b3cde3"))
...
pdf("/Users/tili/Desktop/STAT_ovary/results/figures/cell_type_markers_fresh_cultured_20220708.pdf")
for (i in 1:length(des)){
  print(des[[i]])
}
dev.off()
