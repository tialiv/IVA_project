...
for (i in 1:length(comparisonALL)) {
  comparison05[[names(comparisonALL)[i]]] <- comparisonALL[[i]] %>% filter(pvalue<0.05)
}

comparison001 <- list()
for (i in 1:length(comparisonALL)) {
  comparison001[[names(comparisonALL)[i]]] <- comparisonALL[[i]] %>% filter(pvalue<0.001)
}


save(dds, comparison001, comparisonALL, 
     file = "/Users/tili/Desktop/STAT_ovary/results/DESeq2_H1_removed_fresh_vs_cultured_IVA_included.Rdata")
```
...
load(file = "/Users/tili/Desktop/STAT_ovary/results/DESeq2_H1_removed_fresh_vs_cultured_IVA_included.Rdata")
...
openxlsx::write.xlsx(final, "/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_fresh_cultured_H1_removed_IVA_included_sig01_20220714.xlsx")
...
anno <- info %>% select(cultures, follicle)
...
save(shrunk, shrunk_sig, 
     file = "/Users/tili/Desktop/STAT_ovary/results/DESeq2_H1_removed_IVA_included_fresh_cultured_shrunk.Rdata")
```
...
openxlsx::write.xlsx(gse, "/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_fresh_sigDEGs_enricher_hallmark_IVA_included_20220714.xlsx")
...
openxlsx::write.xlsx(gsea_hallmark, "/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_fresh_sigDEGs_IVA_included_GSEA_hallmark_20220714.xlsx")
