...
write.csv(info_activator, file = paste("/Users/tili/Desktop/STAT_ovary/data/info_activator.csv", sep = ""))

cells_ordered <- re_order(info_activator, cells)
write.csv(cells_ordered, file = paste("/Users/tili/Desktop/STAT_ovary/data/cells_activator.csv", sep = ""))
...
umap_plot_df <- data.frame(umap_results$layout) %>%
        ...
        dplyr::inner_join(info_activator, by = "Sample")
ggplot(umap_plot_df, aes(x = X1, y = X2, color = Activator, shape = Culture)) + geom_point(size = 3) + 
      ggtitle(paste0("UMAP (vst)")) + theme + scale_color_manual(values = c("#8dd3c7","#fb8072")) 
...
```{r Outliers removed}
# A6 and E3 were removed 
cells <- read.delim(file = "/Users/tili/Desktop/STAT_ovary/data/raw_count.txt", skip = 1)
cells <- cells[,-c(2:6)]
cells[is.na(cells)] <- 0  
cells <- re_name(cells)
info_activator <- info_activator[-c(6, 19),]
cells <- re_order(info_activator, cells)

dds <- DESeqDataSetFromMatrix(countData=cells, colData = info_activator, design = ~ Culture + Activator)
...
save(dds, comparison01, comparisonALL, 
     file = "/Users/tili/Desktop/STAT_ovary/results/DESeq2_Activator.Rdata")
```
...
load(file = "/Users/tili/Desktop/STAT_ovary/results/DESeq2_Activator.Rdata")
...
openxlsx::write.xlsx(final, "/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_activator_comparison_sig01_20220706.xlsx")
...
save(shrunk, shrunk_sig, 
     file = "/Users/tili/Desktop/STAT_ovary/results/DESeq2_Activator_shrunk.Rdata")
```
...
openxlsx::write.xlsx(gse_df, "/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_Activator_all_DEGs_enricher_hallmark_20220706.xlsx")
...
openxlsx::write.xlsx(gsea, "/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_Activator_all_DEGs_GSEA_hallmark_20220706.xlsx")
...
openxlsx::write.xlsx(enrich_KEGG_df, "/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_Activator_enricher_KEGG_20220706.xlsx")
...
openxlsx::write.xlsx(enrich_GO_df, "/Users/tili/Desktop/STAT_ovary/results/tables/DESeq2_activator_enrich_GO_20220706.xlsx")
